...
def inference(input_op, keep_prob):
    ...
    conv1_2 = conv_op(conv1_1, name = 'conv1_2', kh = 3, kw = 3,
                      n_out = 64, dh = 1, dw = 1, p = p)
    pool1 = mpool_op(conv1_2, name = 'pool1', kh = 2, kw = 2, dw = 2,
                     dh = 2)
    ...
    pool2 = mpool_op(conv2_2, name = 'pool2', kh = 2, kw = 2, dh = 2,
                     dw = 2)

    conv3_1 = conv_op(pool2, name = 'conv3_1', kh = 3, kw = 3,
                      n_out = 256, dh =1, dw = 1, p = p)
    conv3_2 = conv_op(conv2_1, name = 'conv3_2', kh = 3, kw = 3,
                      n_out=256, dh = 1, dw = 1, p = p)
    ...
    conv4_3 = conv_op(conv4_2, name = 'conv4_3', kh = 3, kw = 3,
                      n_out=512, dh = 1, dw = 1, p = p)
    pool4 = mpool_op(conv4_3, name = 'pool4', kh = 2,
                     kw = 2, dh = 2, dw = 2)
